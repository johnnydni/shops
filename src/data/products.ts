...
export const PRODUCTS: Product[] = [
  ...
  /* ─────────────────────────────────────────────────────────────── */
  {
    ...
    category: 'prints',
    name: 'RITMO Founders Cup',
    nameAccent: 'Cup',
    eyebrow: 'Print, Limited',
    tagline: 'Plakat zur Founders-Edition des RITMO DNA Cups — 18.07.2026, Padel Haus Ingolstadt. A2-Format (50 × 70 cm), nummeriert auf 200 Stück, gedruckt auf 250 g/m² Mattpapier. Gerollt geliefert in einer Kraftpapier-Hülse.',
    shortDesc: 'Limited Founders-Edition-Plakat zum RITMO DNA Cup, 50×70 cm, Premium-Mattpapier 250 g/m².',
    price: 24,
